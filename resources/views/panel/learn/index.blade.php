                    ...
                    <tr>
                        ...
                        @foreach($rows as $row)
                            ...
                            <td style="text-align: center">
                                <img @if($row->image) src="/learn/{{$row->image}}" @else src="\assets\media\image\dark-logo.png" @endif width="50" height="50" class="rounded">
                            </td>
                            ...
                            <td style="text-align: center">
                                ...
                                <a href="/learns/files/{{$row->id}}">
                                    <button class="btn btn-info">فایل ها</button>
                                </a>
                                <a href="/learns/{{$row->id}}/edit">
