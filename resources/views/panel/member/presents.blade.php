...
@section('header')
    <div class="page-header">
        <div>
            <h3> لیست پرزنت شده ها</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="#">لیست اسامی</a></li>
                    <li class="breadcrumb-item active" aria-current="page"> لیست پرزنت شده ها</li>
                </ol>
            </nav>
        </div>
                    ...
                    <tr>
                        ...
                        @foreach($rows as $row)
                            ...
                            <form action="/members/questions/store" method="post">
                                ...
                                <td>
                                    <input class="form-control"  placeholder="1402-08-16" name="present_date" value="{{$row->present_date}}">
                                </td>
                                <td>
                                    <input class="form-control"   name="presentor" value="{{$row->presentor}}">
                                </td>
                                <td>
                                    <select class="form-control" name="present_type">
                                        <option></option>
                                        <option @if($row->present_type=='آنلاین') selected @endif>آنلاین</option>
                                        <option @if($row->present_type=='گروهی آنلاین') selected @endif>گروهی آنلاین</option>
                                        <option @if($row->present_type=='حضوری') selected @endif>حضوری</option>
                                    </select>
