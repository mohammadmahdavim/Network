...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="/exams/{{$row->id}}" method="post" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-3">
                        ...
                        <input style="text-align: center" type="number" id="time" name="time"
                               class="form-control" value="{{$row->time}}" required>
                    </div>
                    <div class=" col-md-3">
                        ...
                        <select name="level_id" class="form-control">
                            @foreach($levels as $level)
                                <option @if($level->id==$row->level_id) selected
                    ...
                    <div class=" col-md-3">
                        ...
                        <input style="text-align: center" class="form-control" type="number" required disabled
                               name="questions_count" value="{{$row->questions_count}}"
