...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="/products/{{$row->id}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" id="price" class="form-control" name="price" required value="{{$row->price}}">
                    </div>
                    <div class="col-md-3">
                        <br>
                        <h6><label>موجودی انبار</label></h6>
                        <input type="number" id="remaining" class="form-control" name="remaining" required value="{{$row->remaining}}">
                    </div>
                </div>
